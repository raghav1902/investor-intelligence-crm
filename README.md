...
- **🤖 Gemini 2.0 Flash Vision OCR:** Intelligently renders source PDF pages into high-resolution canvas buffers and extracts structured contact records (First Name, Last Name, Firm, Email, Title, Sector) directly from PDF documents.
...
- **🌑 Dark Mode & Responsive Design:** Fully responsive layout that adapts to mobile, tablet, and desktop screens with a built-in Dark/Light mode toggle (styled with Tailwind `dark:` classes).
